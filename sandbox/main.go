...
func main() {
	...
	p.CmdFromMap(map[string]string{
		"HOST_NAME": "localhost", "UDP_PORT": "1101", "HTTP_PORT_FILE": "2101", "ProcessName": "P1"},
		"./gossiper", nil)
	p.CmdFromMap(map[string]string{
		"HOST_NAME": "localhost", "UDP_PORT": "1102", "HTTP_PORT_FILE": "2102", "ProcessName": "P2"},
		"./gossiper", nil)
